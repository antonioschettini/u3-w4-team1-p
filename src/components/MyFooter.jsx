      ...
      <Container className="container-mw">
        <Row className="mb-3">
          <Col xs={12} md={4}>
            <a
              href="#"
              className="text-muted small d-block mb-1 text-decoration-none "
            >
              Informazioni
            </a>
            <a
        ...
        <a
          href="#"
          className="text-muted small border-top pt-3 text-decoration-none"
        >
          ...
          <Col xs={12} md={6}>
            <div className="d-flex align-items-start gap-2 mb-2">
              ...
              <div>
                <a
                  href="#"
                  className="fw-bold small mb-0 text-decoration-none text-dark d-block"
                >
                  Domande?
                </a>
                <a
                  href="#"
                  className="text-muted small mb-0 text-decoration-none d-block"
                >
